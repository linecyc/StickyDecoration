...
import com.linecy.module.decoration.GridStickyDecoration;
...
public class GridActivity extends AppCompatActivity {
  ...
  @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    boolean isCustom = getIntent().getBooleanExtra(EXTRA_CUSTOM, false);
    RecyclerView recyclerView = findViewById(R.id.recyclerView);
    recyclerView.setLayoutManager(new GridLayoutManager(this, 4));
    GridAdapter adapter = new GridAdapter();
    recyclerView.setAdapter(adapter);
    GridStickyDecoration stickyDecoration;
    if (isCustom) {
      stickyDecoration = new GridStickyDecoration(
          getLayoutInflater().inflate(R.layout.layout_header, null, false)) {
      ...
      stickyDecoration = new GridStickyDecoration(this);
    }
